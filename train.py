...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--output_dir', default='/home/dell/xhj/xiugai2',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=13, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--detr_model', default='/home/dell/xhj/detr-r50-e632da11.pth', type=str, help='detr model')
...
def main(args):
    ...
    # 修改模型的最后一层分类器
    #num_classes =21  # 替换为你的数据集类别数量（包括背景类别）
    ...
    if args.output_dir and utils.is_main_process():  # get_rank() == 0
        with (output_dir / "log_3mheads_erjiyindao.txt").open("a") as f:
            f.write(str(args) + "\n")
